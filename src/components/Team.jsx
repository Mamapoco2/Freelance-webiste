    ...
    <section className="band band--cream" id="team">
      <div className="wrap">
        <div className="head">
          ...
          <p>
            A front-end and UX designer, a back-end developer, a full-stack
            developer and a project manager — and the line each of us works by.
          </p>
        </div>
          ...
          {team.map((m) => (
            <article className="member" key={m.id}>
              <div className="member__img">
                <img src={m.teamImage} alt={m.name} />
              </div>
                ...
                <div className="member__links">
                  {m.socials.linkedin && (
                    <a
                      ...
                      aria-label={`${m.first} on LinkedIn`}
                    >
                      <Linkedin />
                    </a>
                  )}
